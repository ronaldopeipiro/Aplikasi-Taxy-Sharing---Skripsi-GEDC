...
<div class="container-login100" style="background-image: url('<?= base_url(); ?>/assets/img/bg-login.jpg');">
	<div class="wrap-login100 p-l-20 p-r-20 p-t-40 p-b-40">
		...
		<form action="<?= base_url(); ?>/Driver/Auth/submit_reset_password" method="POST" enctype="multipart/form-data">
			<?= csrf_field(); ?>

			<input type="hidden" name="token_reset_password" value="<?= $token; ?>">
			...
			<div class="row justify-content-center">
				...
				<?php
				$cek_token = ($db->query("SELECT * FROM tb_driver WHERE token_reset_password = '$token' "))->getNumRows();
				?>
				<?php if ($cek_token > 0) : ?>
